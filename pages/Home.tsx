        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="max-w-5xl mx-auto reveal active">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl xl:text-[110px] font-black text-slate-900 leading-[0.9] tracking-tighter uppercase mb-6 md:mb-10 font-jakarta">
              STRENGTH <br />
              <span className="text-cyan-600">BEYOND BORDERS</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 md:space-x-8">
              <Link to="/services" className="bg-slate-900 text-white px-8 md:px-12 py-4 md:py-5 font-black uppercase tracking-widest text-[10px] md:text-[11px] hover:bg-cyan-600 transition-all rounded-sm shadow-2xl w-full sm:w-auto text-center">
                OUR SERVICES
              </Link>
      ...
      <section className="py-20 md:py-40 bg-white">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 md:mb-24 gap-6 md:gap-8 reveal">
            ...
            <Link to="/services" className="text-[10px] md:text-xs font-black uppercase tracking-widest border-b-2 border-slate-900 pb-2 mb-2 hover:text-cyan-600 hover:border-cyan-600 transition-all self-start md:self-end">
              FULL SERVICES LIST
            </Link>
          </div>
              ...
              <div key={s.id} className="reveal group bg-slate-50 p-2 rounded-sm border border-slate-100 hover:border-cyan-500 transition-all duration-700">
                ...
                <div className="px-4 md:px-8 pb-6 md:pb-10">
                  <div className="flex justify-between items-center mb-4 md:mb-6">
                    ...
                    <div className="p-2 md:p-3 bg-white shadow-md text-cyan-500"><Anchor className="w-4 h-4 md:w-5 md:h-5" /></div>
                  </div>
                  <p className="text-slate-500 text-sm italic leading-relaxed mb-6 md:mb-8 max-w-md">{s.description}</p>
                  <Link to={`/services/${s.id}`} className="inline-flex items-center text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-cyan-600 transition-colors">
