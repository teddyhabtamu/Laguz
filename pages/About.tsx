...
const About: React.FC = () => {
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="relative h-[65vh] flex items-center bg-slate-50 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-16 relative z-10 pt-20">
          <div className="max-w-4xl reveal active">
            <span className="text-cyan-600 font-black uppercase tracking-[0.4em] text-[11px] block mb-8">IDENTITY & VISION</span>
            <h1 className="text-6xl md:text-8xl font-black text-slate-900 leading-[0.9] tracking-tighter uppercase mb-10 font-jakarta">
      ...
      <section className="py-40 container mx-auto px-6 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          <div className="reveal">
            <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-10 font-jakarta">About Laguz</h2>
          ...
          <div className="grid grid-cols-2 gap-6 reveal stagger-2">
            <div className="img-zoom-container shadow-2xl">
              <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=800" className="w-full h-96 object-cover grayscale" alt="Team" />
            </div>
            <div className="img-zoom-container shadow-2xl mt-16">
              <img src="https://images.unsplash.com/photo-1497215728101-856f4ea42174?q=80&w=800" className="w-full h-96 object-cover grayscale" alt="Office" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-40 bg-slate-50 border-y border-slate-100">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="max-w-4xl mx-auto text-center reveal mb-16">
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter uppercase mb-10 font-jakarta">How We Work</h2>
            <div className="w-16 h-1 bg-cyan-400 mx-auto"></div>
          </div>
          <div className="max-w-4xl mx-auto reveal">
            <p className="text-xl text-slate-700 leading-relaxed font-bold italic mb-8 text-center">
      ...
      <section className="py-40 container mx-auto px-6 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          <div className="reveal">
            <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-10 font-jakarta">Mission & Goal</h2>
            <div className="space-y-8">
              <p className="text-2xl text-slate-700 leading-relaxed font-bold italic">
          ...
          <div className="reveal stagger-1">
            <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-10 font-jakarta">Management Team</h2>
            <div className="space-y-8">
              <p className="text-2xl text-slate-700 leading-relaxed font-bold italic">
