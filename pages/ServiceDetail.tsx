    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-16 relative z-10">
          <Link to="/services" className="inline-flex items-center space-x-2 text-[10px] font-black uppercase tracking-widest text-slate-400 mb-12 hover:text-cyan-600 transition-colors">
            <ChevronLeft className="w-4 h-4" />
            <span>Back to all services</span>
          </Link>
          <div className="max-w-4xl reveal active">
            <h2 className="text-[#d4a017] font-black uppercase tracking-[0.5em] text-[12px] mb-8 font-jakarta">LOGISTICS MANIFEST</h2>
            <h1 className="text-6xl md:text-8xl lg:text-[120px] font-black text-slate-900 leading-[0.85] tracking-tighter uppercase mb-10 font-jakarta">
      ...
      {/* Detailed Content */}
      <section className="py-40 container mx-auto px-6 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          <div className="reveal">
            <h3 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-12 font-jakarta">Operational Overview</h3>
            <p className="text-2xl text-slate-700 leading-relaxed font-bold italic mb-10">
              {service.description}
            </p>
            ...
            <div className="mt-16 grid grid-cols-2 gap-10">
               <div className="p-8 bg-slate-50 border-l-4 border-[#d4a017]">
                  <ShieldCheck className="w-8 h-8 text-cyan-600 mb-6" />
                  <h4 className="font-black text-slate-900 uppercase text-xs tracking-widest mb-4">Compliance</h4>
                  <p className="text-[11px] text-slate-400 font-medium leading-relaxed italic">Strict adherence to ISO and maritime safety protocols.</p>
               </div>
               <div className="p-8 bg-slate-50 border-l-4 border-cyan-500">
                  <Globe className="w-8 h-8 text-[#d4a017] mb-6" />
                  <h4 className="font-black text-slate-900 uppercase text-xs tracking-widest mb-4">Network</h4>
                  <p className="text-[11px] text-slate-400 font-medium leading-relaxed italic">Connected to 120+ international ports globally.</p>
               </div>
            </div>
          </div>

          <div className="space-y-12 reveal stagger-2">
            ...
            <div className="bg-slate-900 p-12 text-white shadow-2xl">
               <h4 className="text-2xl font-black uppercase tracking-tighter mb-8 font-jakarta">Key Advantages</h4>
               <ul className="space-y-6">
                 {['24/7 Digital Tracking', 'End-to-End Asset Control', 'Disaster Recovery Protocols', 'Customized Route Engineering'].map((item, idx) => (
                   <li key={idx} className="flex items-center space-x-4 group">
                     ...
                     <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-white transition-colors">{item}</span>
                   </li>
                 ))}
               </ul>
               <Link to="/contact" className="mt-12 inline-flex items-center space-x-4 text-cyan-400 font-black uppercase tracking-widest text-[10px] border-b border-cyan-400 pb-2 hover:text-white hover:border-white transition-all">
